...
import {login,signIn,logout} from '../redux/actions/userActions';
...
class Main extends Component {  
    ...
    render() {
        ...
        return (
            <div className="App">
                <Header login = {this.props.login} user = {this.props.user.user} signIn = {this.props.signIn} logout = {this.props.logout}/>
                <TransitionGroup>
